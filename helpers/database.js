...
const info = require('../config'); // define an async utility function to get a connection 
...
exports.run_query = async function run_query(query, values) {
	try {
		...
		return data;
	} catch (error) { // Don't let the actual error propagate up to the response object 
